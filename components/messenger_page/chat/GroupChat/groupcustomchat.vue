    ...
    <div class="contact-chat">
        <ul class="chatappend">
          <li class="groupuser" v-if="currentChat.chat.id == 0">
            ...
            <div class="gr-chat-friend-toggle"><a class="icon-btn btn-sm pull-right add-grbtn outside" href="javascript:void(0)" @click="togglechatuser()" data-tippy-content="Add User"><Icon name="lucide:plus" size="15" height="15"></Icon></a>
          ...
          {
            'background-image':
              'url(' + getImgUrl(`${config.public.baseURL}${user.img }`) + ')',
          },
          styleObject,
        ]">
                    </div>
                        ...
                        <div class="flex-grow-1"><a class="icon-btn btn-outline-primary btn-sm" href="javascript:void(0)"  @click="showchatuser= false" data-tippy-content="Add User"><i class="fa fa-plus"></i></a></div>
                      </div>
                    </div>
                  </li>
                </ul>
          ...
          <template v-if="currentChat.chat.messages.length">
            ...
            <li :class="typing ? 'sent last typing-': 'sent'" :style="typing? 'display: block': 'display: none'">
              <div class="d-flex">
                 <div class="profile me-4" :style="[{'background-image': 'url(' + getImgUrl('contact/1.jpg') + ')'},styleObject]"></div>
                 <div class="flex-grow-1">
                    <div class="contact-name">
...
const config = useRuntimeConfig();
    ...
    const groupchatuser = computed(() => chatStore.groupchatuser);
    const typing = computed(() => chatStore.typing);
...
const togglechatuser = () => {
      showchatuser.value = !showchatuser.value;
    };
