              ...
              <form class="form1">
                ...
                <div class="form-group">
                  <div class="rememberchk">
                    <div class="input-text form-check ps-0">
                      <input type="checkbox" id="gridCheck1" />
                      <label
                        class="form-check-label ms-2 me-auto p-0"
                        for="gridCheck1">Remember Me</label>
                      <h6 class="pull-right"><nuxt-link to="/authentication/signup">Forgot Password?</nuxt-link></h6>
                    </div>
                  </div>
                </div>
                <div class="form-group">
