        ...
        <div class="form2 text-white">
          ...
          <div class="form-group">
            ...
            <Multiselect v-model="sexualInterest" :options="allOptions.interests" track-by="interest_id"
              ...
              placeholder="Select Sexual Interest" :reduce="interestToId" />
          </div>
          ...
          <div class="form-group">
            ...
            <Multiselect v-model="meetPreference" :options="allOptions.meetPerferences" track-by="looking_for_id"
              label="looking_for_name" :multiple="true" :close-on-select="false" placeholder="Select Looking For"
