      ...
      <div class="custom-container">
        <div class="row">
          <div class="col-12">
            <div>
              <div>
                <swiper :breakpoints="swiperOption.breakpoints" Swiper :slidesPerView="4" :mousewheel="true" :spaceBetween="10"
                :loop="true"  :pagination="{clickable: true,}" :modules="modules" class="swiper-wrapper">
                  <swiper-slide
                    class="swiper-slide"
