            ...
            <div class="element-card">
              ...
              <div class="element-card-body typography">
                <div class="theme-btn-group fonts">
                  <div class="dot-btn dot-success grow"><a class="icon-btn btn-primary button-effect btn-sm" href="javascript:void(0)"><Icon name="lucide:circle" size="15" /></a></div>
                  <div class="dot-btn dot-success grow"><a class="icon-btn btn-success button-effect btn-sm" href="javascript:void(0)"><Icon name="lucide:users" size="15" height="15"></Icon></a></div>
                </div>
                <div class="theme-btn-group fonts"><a class="icon-btn btn-primary button-effect btn-sm" href="javascript:void(0)"><Icon name="lucide:circle" size="15" height="15"></Icon></a><a class="icon-btn btn-success button-effect btn-sm" href="javascript:void(0)"><Icon name="lucide:users" size="15" height="15"></Icon></a><a class="icon-btn btn-success button-effect btn-sm" href="javascript:void(0)"><Icon name="lucide:users" size="15" height="15"></Icon></a></div>
                <div class="theme-btn-group fonts"><a class="icon-btn btn-primary button-effect" href="javascript:void(0)"><Icon name="lucide:circle" size="15" height="15"></Icon></a><a class="icon-btn btn-success button-effect" href="javascript:void(0)"><Icon name="lucide:users" size="15" height="15"></Icon></a></div>
                <div class="theme-btn-group fonts"><a class="icon-btn btn-primary button-effect" href="javascript:void(0)"><Icon name="lucide:circle" size="15" height="15"></Icon></a><a class="icon-btn btn-primary button-effect" href="javascript:void(0)"><Icon name="lucide:circle" size="15" height="15"></Icon></a><a class="icon-btn btn-success button-effect" href="javascript:void(0)"><Icon name="lucide:users" size="15" height="15"></Icon></a></div>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-sm-12">
