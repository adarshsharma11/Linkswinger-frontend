                ...
                <div class="collapse-block" v-bind:class="{ open: openmedia }">
                  ...
                  <div class="block-content" v-bind:style=" openmedia ? 'display: ;' : 'display: none;' ">
                    <div class="share-media">
                      <div class="row">
                        <div class="col-4">
                          <div class="media-big bg-size" :style="[{'background-image': 'url(' + getImgUrl('avtar/1.jpg') + ')'},styleObject]"></div>
                        </div>
                        <div class="col-4">
                          <div class="media-small" :style="[{'background-image': 'url(' + getImgUrl('avtar/5.jpg') + ')'},styleObject]"></div>
                          <div class="media-small" :style="[{'background-image': 'url(' + getImgUrl('avtar/2.jpg') + ')'},styleObject]"></div>
                        </div>
                        <div class="col-4">
                          <div class="media-small" :style="[{'background-image': 'url(' + getImgUrl('avtar/big/audiocall.jpg') + ')'},styleObject]"></div>
                          <div class="media-small" :style="[{'background-image': 'url(' + getImgUrl('avtar/4.jpg') + ')'},styleObject]"></div>
                        </div>
                      </div>
                    </div>
                  </div>
...
const togglemedia = () => {
  openmedia.value = !openmedia.value;
};
