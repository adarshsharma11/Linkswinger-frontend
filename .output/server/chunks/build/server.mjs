import { defineComponent, shallowRef, getCurrentInstance, provide, cloneVNode, h as h$1, createElementBlock, hasInjectionContext, defineAsyncComponent, pushScopeId, popScopeId, inject, computed, unref, shallowReactive, ref, Suspense, Fragment, createApp, nextTick, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, openBlock, normalizeClass, renderSlot, normalizeProps, guardReactiveProps, resolveComponent, createBlock, mergeProps, withCtx, getCurrentScope, toDisplayString, withScopeId, useSSRContext, withKeys, normalizeStyle, createElementVNode, createCommentVNode } from 'vue';
...
const _routes = [
  ...
  },
  {
    name: "bonus-faq",
    path: "/bonus/faq",
    component: () => import('./faq-BuGiJkrd.mjs')
  },
  {
    name: "bonus-about",
    path: "/bonus/about",
    component: () => import('./about-CN7Pf2DG.mjs')
  },
  {
    name: "bonus-price",
    path: "/bonus/price",
    component: () => import('./price-1bOcb_Ly.mjs')
  },
  {
    name: "bonus-elements",
    path: "/bonus/elements",
    component: () => import('./elements-B6MTnhwo.mjs')
  },
  {
    name: "messenger-messenger",
    path: "/messenger/messenger",
    component: () => import('./messenger-D-fF_Ujx.mjs')
  },
  {
    name: "authentication-login",
    path: "/authentication/login",
    component: () => import('./login-XhpTHlg1.mjs')
  },
  {
    name: "authentication-signup",
    path: "/authentication/signup",
    component: () => import('./signup-EYACqhyL.mjs')
  },
  {
    name: "authentication-login-2",
    path: "/authentication/login-2",
    component: () => import('./login-2-DlQSZW-K.mjs')
  },
  {
    name: "authentication-signup-2",
    path: "/authentication/signup-2",
    component: () => import('./signup-2-BISGKHkB.mjs')
  },
  {
    name: "blogs-blog_details",
    path: "/blogs/blog_details",
    component: () => import('./index-Cal9HwGY.mjs')
  },
  {
    name: "blogs-blog_no-sidebar",
    path: "/blogs/blog_no-sidebar",
    component: () => import('./index-F0KpFS3E.mjs')
  },
  {
    name: "blogs-blog_left-sidebar",
    path: "/blogs/blog_left-sidebar",
    component: () => import('./index-DOifSoUq.mjs')
  },
  {
    name: "authentication-forget_password",
    path: "/authentication/forget_password",
    component: () => import('./forget_password-BYQDK3Bh.mjs')
  },
  {
    name: "blogs-blog_right-sidebar",
    path: "/blogs/blog_right-sidebar",
    component: () => import('./index-DYitzpFS.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./Icon-Dtzd5Hz1.mjs').then((r) => r["default"] || r.default || r));
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-BUFZIW9d.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CSRhBh6X.mjs').then((m2) => m2.default || m2))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Beo3n9PQ.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-C1_h60Fo.mjs'));
...
export { _export_sfc as _, __nuxt_component_0$1 as a, useRouter as b, useNuxtApp as c, nuxtLinkDefaults as d, entry$1 as default, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRuntimeConfig as u };
