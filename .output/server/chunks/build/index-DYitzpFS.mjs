...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/blogs/right-sidebar.vue");
...
const _sfc_main = {
  ...
  setup(__props) {
    useHead({
      title: "Blog Right Sidebar- Chat Messenger Nuxt Template"
    });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_BlogsCommonBlogHeader = __nuxt_component_0;
      const _component_BlogsRightSidebar = __nuxt_component_1;
      ...
      _push(ssrRenderComponent(_component_BlogsRightSidebar, null, null, _parent));
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/blogs/blog_right-sidebar/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-DYitzpFS.mjs.map
