...
import { _ as _imports_0$1 } from './virtual_public-DloTEvNs.mjs';
import { _ as _export_sfc, a as __nuxt_component_0$1$1 } from './server.mjs';
import { p as publicAssetsURL } from '../routes/renderer.mjs';

const _imports_0 = publicAssetsURL("/images/landing/footer/2.png");
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_nuxt_link, mergeProps({
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="logo-block"${_scopeId}><img class="img-fluid"${ssrRenderAttr("src", _imports_0$1)} alt="logo"${_scopeId}></div>`);
      } else {
        return [
...
export { _sfc_main$2 as _, __nuxt_component_2 as a, __nuxt_component_3 as b, _imports_0 as c };
//# sourceMappingURL=taptop-BxHDPFN5.mjs.map
