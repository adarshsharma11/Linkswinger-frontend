...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./entry-styles.CpGXGpUm.mjs').then(interopDefault),
  ...
  "components/Authentication/login.vue": () => import('./login-styles.Jz6_uIL1.mjs').then(interopDefault)
};
