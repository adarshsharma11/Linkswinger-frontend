...
const _sfc_main = {
  ...
  setup(__props) {
    useHead({
      title: "Bonus Elements - Chat Messenger Nuxt Template"
    });
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/bonus/elements.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=elements-B6MTnhwo.js.map
