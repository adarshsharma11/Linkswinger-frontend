import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, createElementBlock, provide, cloneVNode, h as h$1, defineAsyncComponent, pushScopeId, popScopeId, nextTick, openBlock, normalizeClass, renderSlot, normalizeProps, guardReactiveProps, resolveComponent, createBlock, mergeProps, withCtx, createVNode, withScopeId, withKeys, normalizeStyle, createElementVNode, createCommentVNode, Fragment, ref, createApp, toDisplayString, computed, unref, Suspense, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent } from "vue";
import { $fetch } from "ofetch";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/varun/Desktop/Data/projects/web/linkswinger/linkswinger/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/varun/Desktop/Data/projects/web/linkswinger/linkswinger/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "/Users/varun/Desktop/Data/projects/web/linkswinger/linkswinger/node_modules/h3/dist/index.mjs";
import { shouldHydrate, createPinia, setActivePinia } from "pinia";
import { defu } from "/Users/varun/Desktop/Data/projects/web/linkswinger/linkswinger/node_modules/defu/dist/defu.mjs";
...
import { toRouteMatcher, createRouter } from "/Users/varun/Desktop/Data/projects/web/linkswinger/linkswinger/node_modules/radix3/dist/index.mjs";
import { hasProtocol, joinURL, withQuery, isScriptProtocol } from "/Users/varun/Desktop/Data/projects/web/linkswinger/linkswinger/node_modules/ufo/dist/index.mjs";
import "/Users/varun/Desktop/Data/projects/web/linkswinger/linkswinger/node_modules/klona/dist/index.mjs";
import { evaluate, placements, getAlignmentSides, getSide, getAlignment, getSideAxis, getOppositeAxis, clamp, getOppositePlacement, getExpandedPlacements, getOppositeAxisPlacements, getPaddingObject, getAlignmentAxis, getAxisLength, min as min$1, max as max$1, getOppositeAlignmentPlacement, rectToClientRect } from "@floating-ui/utils";
...
const _routes = [
  ...
  },
  {
    name: "bonus-faq",
    path: "/bonus/faq",
    component: () => import("./_nuxt/faq-BuGiJkrd.js")
  },
  {
    name: "bonus-about",
    path: "/bonus/about",
    component: () => import("./_nuxt/about-CN7Pf2DG.js")
  },
  {
    name: "bonus-price",
    path: "/bonus/price",
    component: () => import("./_nuxt/price-1bOcb_Ly.js")
  },
  {
    name: "bonus-elements",
    path: "/bonus/elements",
    component: () => import("./_nuxt/elements-B6MTnhwo.js")
  },
  {
    name: "messenger-messenger",
    path: "/messenger/messenger",
    component: () => import("./_nuxt/messenger-D-fF_Ujx.js")
  },
  {
    name: "authentication-login",
    path: "/authentication/login",
    component: () => import("./_nuxt/login-XhpTHlg1.js")
  },
  {
    name: "authentication-signup",
    path: "/authentication/signup",
    component: () => import("./_nuxt/signup-EYACqhyL.js")
  },
  {
    name: "authentication-login-2",
    path: "/authentication/login-2",
    component: () => import("./_nuxt/login-2-DlQSZW-K.js")
  },
  {
    name: "authentication-signup-2",
    path: "/authentication/signup-2",
    component: () => import("./_nuxt/signup-2-BISGKHkB.js")
  },
  {
    name: "blogs-blog_details",
    path: "/blogs/blog_details",
    component: () => import("./_nuxt/index-Cal9HwGY.js")
  },
  {
    name: "blogs-blog_no-sidebar",
    path: "/blogs/blog_no-sidebar",
    component: () => import("./_nuxt/index-F0KpFS3E.js")
  },
  {
    name: "blogs-blog_left-sidebar",
    path: "/blogs/blog_left-sidebar",
    component: () => import("./_nuxt/index-DOifSoUq.js")
  },
  {
    name: "authentication-forget_password",
    path: "/authentication/forget_password",
    component: () => import("./_nuxt/forget_password-BYQDK3Bh.js")
  },
  {
    name: "blogs-blog_right-sidebar",
    path: "/blogs/blog_right-sidebar",
    component: () => import("./_nuxt/index-DYitzpFS.js")
  }
];
...
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/Icon-Dtzd5Hz1.js").then((r) => r["default"] || r.default || r));
const LazyIconCSS = defineAsyncComponent(() => import("./_nuxt/IconCSS-BUFZIW9d.js").then((r) => r["default"] || r.default || r));
...
const floating_vue_0VJpPLm37OmsRfOoVrjUztB_kqo8e0M_PqepnJl50BQ = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-CSRhBh6X.js").then((m2) => m2.default || m2))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-Beo3n9PQ.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-C1_h60Fo.js"));
